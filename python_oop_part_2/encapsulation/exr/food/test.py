from python_oop_part_2.encapsulation.exr.food.beverage.beverage import Beverage
from python_oop_part_2.encapsulation.exr.food.food.soup import Soup
from python_oop_part_2.encapsulation.exr.food.product import Product
